...
- External services: Stripe for checkout/payment portal; Cloudflare Email Service and Email Routing for transactional delivery plus support replies; Amazon SES for consent-aware marketing transport; QuickBooks via QBO sync functions; and Supabase for auth/data, marketing consent, suppression, and delivery state.
