...
const ALLOWED = new Set([
  ...
  "0 0 0 3px rgba(156, 225, 220, .12)",
  "0 0 0 3px rgba(226, 165, 99, .16)",
  "0 0 0 3px var(--accent-soft)",
  "0 0 0 4px rgba(14,124,134,.16), var(--shadow-sm)",
  "0 0 0 4px var(--accent-soft)",
  "0 0 18px rgba(121, 199, 197, .85), -24px 0 52px rgba(121, 199, 197, .16)",
  ...
  "0 14px 32px rgba(9, 46, 52, .1)",
  "0 14px 34px rgba(4, 50, 54, .06)",
  "0 14px 38px rgba(4, 50, 54, .08)",
  "0 16px 32px rgb(0 0 0 / 18%)",
  "0 18px 28px -22px rgba(0, 0, 0, .58), inset 0 1px rgba(255, 255, 255, .07)",
  ...
  "0 24px 54px -30px rgba(0, 0, 0, .72)",
  "0 24px 58px rgba(4, 50, 54, .1)",
