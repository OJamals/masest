...
const MAIN_RELEASE = "20260807f";
const ADMIN_RELEASE = "20260807f";
const ADMIN_PAGE_RELEASE = "20260807f";
const CHROME_RELEASE = "20260807f";
const ACCOUNT_NAV_RELEASE = "20260807f";
const CUSTOMER_CHAT_RELEASE = "20260807f";
const CUSTOMER_CHAT_STYLE_RELEASE = "20260719c";
const CONTENT_RELEASE = "20260807f";
