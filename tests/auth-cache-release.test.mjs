...
const RELEASE = "20260910b";
const CHAT_RELEASE = "20260910b";
const MAIN_RELEASE = "20260910b";
const ADMIN_RELEASE = "20260910b";
const ADMIN_PAGE_RELEASE = "20260910b";
const ADMIN_ACCOUNTS_RELEASE = "20260910b";
const ADMIN_WORKFLOW_RELEASE = "20260910b";
const ADMIN_CHROME_RELEASE = "20260910b";
const CHROME_RELEASE = MAIN_RELEASE;
const ACCOUNT_NAV_RELEASE = "20260910b";
const CUSTOMER_CHAT_RELEASE = "20260910b";
const CUSTOMER_CHAT_STYLE_RELEASE = "20260910b";
const CONTENT_RELEASE = "20260910b";
const STORY_RELEASE = "20260911b";   // story.js changed independently of the site release
const PUBLIC_SUPPORT_RELEASE = "20260910b";
const ADMIN_SUPPORT_RELEASE = "20260910b";
const ADMIN_SUPPORT_STYLE_RELEASE = "20260910b";
...
test("auth-consuming module paths are refreshed from their page entrypoints", () => {
  ...
  assert.match(read("js/main/chrome.js"), new RegExp(`account-nav\\.js\\?v=${ACCOUNT_NAV_RELEASE}`));
  ...
  assert.match(read("js/customer-chat.js"), new RegExp(`admin-support\\.js\\?v=${PUBLIC_SUPPORT_RELEASE}`));
  assert.match(read("js/admin/threads.js"), new RegExp(`admin-support\\.js\\?v=${ADMIN_SUPPORT_RELEASE}`));
