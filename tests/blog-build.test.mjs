  ...
  try {
    buildBlog({ posts: [
      { slug: "with-hero", title: "With Hero", category: "news", date: "2026-02-02",
        excerpt: "e", body: "b", hero: "img/blog/x.webp", hero_alt: "a coil" },
    ...
    assert.match(idx, /<img class="blog-card-img" src="img\/blog\/x\.webp" alt="a coil"/);
    ...
    assert.match(post, /<figure class="blog-hero-media"><img src="\.\.\/img\/blog\/x\.webp" alt="a coil"/);
