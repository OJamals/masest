...
// pages (products/*.html) from a shared release token. It should keep a
...
test("seo-inject product template carries a style.css cache-bust", () => {
  ...
  assert.match(STYLE_VERSION, /^[0-9]{8}[a-z]?$/i, "shared style.css cache-bust should be date-like");
});
