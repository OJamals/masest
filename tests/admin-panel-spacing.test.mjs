...
export async function api(path) {
  ...
  if (pathname.startsWith("/api/admin/stats")) return { orders: 1, revenue: 0, pending_companies: 1, unread_messages: 0, new_quotes: 0, low_stock: 0, setup_followups: [], recent_orders: [], companies: { pending: 1, approved: 2, suspended: 0 }, accounts: { pending: 1, approved: 2, suspended: 0 }, commerce: {}, crm: {}, catalog_health: {}, analytics: {}, traffic: {}, request_queue: Array.from({ length: 12 }, (_, index) => ({ label: "Follow up with Great Lakes Industrial Water Treatment and Facilities Procurement about a multi-site VertKlean evaluation", value: index + 1, href: index % 2 ? "#quotes" : "#crm" })), staff_context: window.__TEST_STAFF_CONTEXT };
