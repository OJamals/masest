...
test('sendEmail accepts idempotency/reply/text options', () => {
  assert.match(src, /export async function sendEmail\(env, \{ to, bcc = \[\], subject, html, text = null, category = null, idempotencyKey = null, replyTo = null \}\)/);
});
