...
`/*
  ...
  Content-Security-Policy: default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'self'; img-src 'self' data: https:; font-src 'self'; style-src 'self' 'unsafe-inline' https://client.crisp.chat; script-src 'self' 'unsafe-inline' https://challenges.cloudflare.com https://client.crisp.chat https://settings.crisp.chat https://static.cloudflareinsights.com; connect-src 'self' https://*.supabase.co https://api.stripe.com https://api.crisp.chat https://client.crisp.chat https://settings.crisp.chat https://*.crisp.chat https://cloudflareinsights.com https://static.cloudflareinsights.com wss://*.crisp.chat; frame-src https://challenges.cloudflare.com https://client.crisp.chat https://game.crisp.chat; form-action 'self'; upgrade-insecure-requests
`);
