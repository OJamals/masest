...
const FIELD_MAP = {
  ...
  QBO_SHIPPING_INCOME_ACCOUNT_ID: "QBO_SHIPPING_INCOME_ACCOUNT_ID",
  QBO_MERCHANT_FEES_ACCOUNT_ID: "QBO_MERCHANT_FEES_ACCOUNT_ID",
  QBO_POSTAGE_EXPENSE_ACCOUNT_ID: "QBO_POSTAGE_EXPENSE_ACCOUNT_ID",
  QBO_STRIPE_CLEARING_ACCOUNT_ID: "QBO_STRIPE_CLEARING_ACCOUNT_ID",
  QBO_BANK_ACCOUNT_ID: "QBO_BANK_ACCOUNT_ID",
  QBO_TAX_LIABILITY_ACCOUNT_ID: "QBO_TAX_LIABILITY_ACCOUNT_ID",
  QBO_DISCOUNTS_ACCOUNT_ID: "QBO_DISCOUNTS_ACCOUNT_ID",
  QBO_REFUNDS_ACCOUNT_ID: "QBO_REFUNDS_ACCOUNT_ID",
  QBO_DISPUTES_ACCOUNT_ID: "QBO_DISPUTES_ACCOUNT_ID",
  ...
  shipping_income_account_id: "QBO_SHIPPING_INCOME_ACCOUNT_ID",
  shippingIncomeAccountId: "QBO_SHIPPING_INCOME_ACCOUNT_ID",
  merchant_fees_account_id: "QBO_MERCHANT_FEES_ACCOUNT_ID",
  merchantFeesAccountId: "QBO_MERCHANT_FEES_ACCOUNT_ID",
  postage_expense_account_id: "QBO_POSTAGE_EXPENSE_ACCOUNT_ID",
  postageExpenseAccountId: "QBO_POSTAGE_EXPENSE_ACCOUNT_ID",
  stripe_clearing_account_id: "QBO_STRIPE_CLEARING_ACCOUNT_ID",
  stripeClearingAccountId: "QBO_STRIPE_CLEARING_ACCOUNT_ID",
  bank_account_id: "QBO_BANK_ACCOUNT_ID",
  bankAccountId: "QBO_BANK_ACCOUNT_ID",
  tax_liability_account_id: "QBO_TAX_LIABILITY_ACCOUNT_ID",
  taxLiabilityAccountId: "QBO_TAX_LIABILITY_ACCOUNT_ID",
  discounts_account_id: "QBO_DISCOUNTS_ACCOUNT_ID",
  discountsAccountId: "QBO_DISCOUNTS_ACCOUNT_ID",
  refunds_account_id: "QBO_REFUNDS_ACCOUNT_ID",
  refundsAccountId: "QBO_REFUNDS_ACCOUNT_ID",
  disputes_account_id: "QBO_DISPUTES_ACCOUNT_ID",
  disputesAccountId: "QBO_DISPUTES_ACCOUNT_ID",
