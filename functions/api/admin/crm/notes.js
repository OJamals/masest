...
export async function onRequest({ request, env }) {
  ...
  if (request.method === 'GET') {
    ...
    if (error) {
      ...
      return internalServerError('admin.crm.notes.list', error);
    }
  ...
  if (request.method === 'POST') {
    ...
    if (error) return internalServerError('admin.crm.notes.create', error);
  ...
  if (request.method === 'DELETE') {
    ...
    if (getErr) return internalServerError('admin.crm.notes.read_for_delete', getErr);
    ...
    if (error) return internalServerError('admin.crm.notes.delete', error);
