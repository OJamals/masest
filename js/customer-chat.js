  ...
  try {
    ...
    if (await session.getToken()) {
      ...
      if (account?.can_admin) {
        const { initAdminSupport } = await import("./admin-support.js?v=20260711e");
    ...
    <section class="customer-chat__panel" role="dialog" aria-labelledby="customerChatTitle" hidden>
      ...
      <div class="customer-chat__thread" hidden>
        ...
        <form class="customer-chat__form">
          ...
          <textarea id="customerChatBody" name="chat_message" autocomplete="off" maxlength="4000" required placeholder="Ask about VertKlean, an order, or your account…"></textarea>
