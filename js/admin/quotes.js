...
import { esc, delegate, money, confirmDialog, dateTime, restoreFocusOnClose } from '../util.js?v=20260711p';
import { captureDirty, restoreDirty } from './edits.js?v=20260711p';
import { createCrmPanel } from './crm.js?v=20260711p';
import { createSavedViews } from './saved-views.js?v=20260711p';
