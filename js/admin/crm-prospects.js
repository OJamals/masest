...
import { esc, delegate, confirmDialog } from '../util.js?v=20260910a';
import { createCrmProspectAccount, renderProspectChannels } from './crm-prospect-account.js?v=20260910a';
