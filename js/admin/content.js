import { esc, delegate, confirmDialog, fmtDate } from "../util.js?v=20260806b";
import { renderMarkdown } from "../md.js?v=20260806b";
import { supabase } from "../auth.js?v=20260806b";
import { createContentAssets } from "./content-assets.js?v=20260806b";
import { openImageLibraryPicker } from "./image-library-picker.js?v=20260806b";
import { createContentRevisions } from "./content-revisions.js?v=20260806b";
import {
  createRichTextEditor,
  insertMarkdownIntoRichEditor,
  referencePickerTemplate as richReferencePickerTemplate,
  richEditorTemplate,
} from "./rich-editor.js?v=20260806b";
import {
...
} from "../content-types.js?v=20260806b";
