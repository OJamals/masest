...
function renderCatalog(root, catalog) {
  ...
  import("../reviews.js?v=20260925a").then((m) => m.initReviewMounts(root)).catch(() => {});
}
...
import { searchTextMatchesQuery } from "./fuzzy-search.js?v=20260925a";
import { loadPricingData } from "./pricing-data.js?v=20260925a";
