import { CATALOG_GROUPS, PRODUCT_CATALOG_COPY, PRODUCTS } from "./catalog-data.js?v=20260915a";
import { normalizeSearchText, searchValueTokenQuality } from "./fuzzy-search.js?v=20260915a";
