...
import { CATALOG_GROUPS, CATALOG_ORDER, PRODUCT_CATALOG_COPY, PRODUCTS, QUOTE_FIRST_IDS, catalogImageDimensions } from "./catalog-data.js?v=20260830f";
import { smoothPref } from "./engagement.js";
import { normalizeProductSearch, rankProductIds } from "./product-search.js?v=20260830f";
