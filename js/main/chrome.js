...
export function renderChrome({
  authModule = "/js/auth.js?v=20260911f",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260911f").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260911f`;
    cfg.onload = () => {
      ["integrations.js?v=20260911f", "customer-chat.js?v=20260911f"].forEach((src) => {
