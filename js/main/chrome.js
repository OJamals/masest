...
export function renderChrome({
  authModule = "/js/auth.js?v=20260911c",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260911c").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260911c`;
    cfg.onload = () => {
      ["integrations.js?v=20260911c", "customer-chat.js?v=20260911c"].forEach((src) => {
