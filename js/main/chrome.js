...
export function renderChrome({
  authModule = "/js/auth.js?v=20260925a",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260925a").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260925a`;
    cfg.onload = () => {
      ["integrations.js?v=20260925a", "customer-chat.js?v=20260925a"].forEach((src) => {
