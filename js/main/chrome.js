...
export function renderChrome({
  authModule = "/js/auth.js?v=20260911e",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260911e").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260911e`;
    cfg.onload = () => {
      ["integrations.js?v=20260911e", "customer-chat.js?v=20260911e"].forEach((src) => {
