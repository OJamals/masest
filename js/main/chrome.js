...
export function renderChrome({
  authModule = "/js/auth.js?v=20260911d",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260911d").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260911d`;
    cfg.onload = () => {
      ["integrations.js?v=20260911d", "customer-chat.js?v=20260911d"].forEach((src) => {
