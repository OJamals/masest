...
export function renderChrome({
  authModule = "/js/auth.js?v=20260910b",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260910b").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260910b`;
    cfg.onload = () => {
      ["integrations.js?v=20260910b", "customer-chat.js?v=20260910b"].forEach((src) => {
