...
export function renderChrome({
  authModule = "/js/auth.js?v=20260912a",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260912a").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260912a`;
    cfg.onload = () => {
      ["integrations.js?v=20260912a", "customer-chat.js?v=20260912a"].forEach((src) => {
