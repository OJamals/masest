...
export function renderChrome({
  authModule = "/js/auth.js?v=20260911g",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260911g").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260911g`;
    cfg.onload = () => {
      ["integrations.js?v=20260911g", "customer-chat.js?v=20260911g"].forEach((src) => {
