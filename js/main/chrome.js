...
export function renderChrome({
  authModule = "/js/auth.js?v=20260913a",
 ...
 "",
  ...
  import("/js/account-nav.js?v=20260913a").then((m) => (
  ...
  if (!window.__masestIntegrations) {
    ...
    cfg.src = `${root}js/config.js?v=20260913a`;
    cfg.onload = () => {
      ["integrations.js?v=20260913a", "customer-chat.js?v=20260913a"].forEach((src) => {
