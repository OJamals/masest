...
const staffSurfaceModule = () => import('./staff-surface.js?v=20260912a');
...
export async function initAccountNav({
  nav,
  root = '',
  authModule = './auth.js?v=20260912a',
...
async function renderAccountNav(actions, root = '', authModule = './auth.js?v=20260912a', resolveSession = false) {
