...
const staffSurfaceModule = () => import('./staff-surface.js?v=20260911g');
...
export async function initAccountNav({
  nav,
  root = '',
  authModule = './auth.js?v=20260911g',
...
async function renderAccountNav(actions, root = '', authModule = './auth.js?v=20260911g', resolveSession = false) {
