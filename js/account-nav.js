...
const staffSurfaceModule = () => import('./staff-surface.js?v=20260925a');
...
export async function initAccountNav({
  nav,
  root = '',
  authModule = './auth.js?v=20260925a',
...
async function renderAccountNav(actions, root = '', authModule = './auth.js?v=20260925a', resolveSession = false) {
