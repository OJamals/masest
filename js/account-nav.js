...
const staffSurfaceModule = () => import('./staff-surface.js?v=20260911c');
...
export async function initAccountNav({
  nav,
  root = '',
  authModule = './auth.js?v=20260911c',
...
async function renderAccountNav(actions, root = '', authModule = './auth.js?v=20260911c', resolveSession = false) {
