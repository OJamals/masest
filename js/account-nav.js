...
const staffSurfaceModule = () => import('./staff-surface.js?v=20260911f');
...
export async function initAccountNav({
  nav,
  root = '',
  authModule = './auth.js?v=20260911f',
...
async function renderAccountNav(actions, root = '', authModule = './auth.js?v=20260911f', resolveSession = false) {
