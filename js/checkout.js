import { shippingServiceLabel, shippingServiceSummary } from './shipping-service-label.js?v=20260911d';
import { catalogImageDimensions } from './main/catalog-data.js?v=20260911d';
import {
  createShippingRequestCoordinator,
  fetchShippingJson,
  shippingRequestSnapshot,
} from './shipping-request.js?v=20260911d';
...
function checkoutError(error) {
  ...
  return ({
    ...
    shipping_package_profile_missing: 'We cannot calculate shipping for one item in this cart. Ask us for a freight quote.',
    shipping_cart_too_large: 'This order is large enough to need a freight quote. Send us your cart and delivery details.',
    shipping_rates_unavailable: 'No shipping option is available for this address and cart.',
    shipping_rates_timeout: 'Shipping options took too long to load. Try again.',
    shipping_rates_not_configured: 'Shipping options are offline. Contact MASEST and we will help place your order.',
    shipping_quote_not_configured: 'Shipping options are offline. Contact MASEST and we will help place your order.',
    shipping_carriers_unavailable: 'No shipping option is available right now. Try again shortly.',
    shipping_quote_expired: 'That shipping price expired. Calculate shipping again before payment.',
    shipping_quote_cart_changed: 'Your cart changed. Calculate shipping again before payment.',
    shipping_quote_required: 'Calculate shipping before continuing to payment.',
    shipping_quote_invalid: 'That shipping choice is no longer available. Calculate shipping again.',
    shipping_quote_legacy: 'That shipping price needs a refresh. Calculate shipping again.',
    shipping_plan_not_found: 'That shipping choice is no longer available. Calculate shipping again.',
    shipping_plan_mismatch: 'Your shipping details changed. Calculate shipping again before payment.',
    shipping_plan_integrity_failed: 'We could not confirm your shipping details. Calculate shipping again before payment.',
    shipping_plan_store_unavailable: 'We could not save your shipping choice. Calculate shipping again.',
    ...
    not_purchasable: `These items need a freight quote before checkout${skuList}. Use the quote form.`,
    ...
    net_checkout_unavailable: 'Pay-later ordering is set up through your MASEST account team. Request a quote to use it.',
    quote_checkout_window_too_short: 'This quote expires too soon for online payment. Ask your account team for a new expiration date.',
    quote_checkout_processing: 'Your payment went through. We are finishing the order now; refresh your Orders list shortly.',
    quote_checkout_busy: 'This quote changed in another tab. Wait a moment and try again.',
    quote_checkout_attempt_unavailable: 'We could not reopen this payment. Try again before starting another one.',
    quote_checkout_expiry_unverified: 'We could not close the earlier payment attempt. Try again shortly.',
    ...
    store_credit_reservation_conflict: 'This account-credit attempt is no longer active. Open payment again.',
    store_credit_reservation_expired: 'Your account credit expired for this payment. Open payment again.',
    store_credit_reservation_failed: 'We could not apply account credit. Try again.',
    store_credit_attach_failed: 'Payment opened before account credit was ready. Try again to resume the same payment.',
...
async function boot() {
  const [cartModule, autocompleteModule, authModule, staffModule] = await Promise.all([
    import('./cart.js'),
    import('./address-autocomplete.js?v=20260911d'),
    import('./auth.js?v=20260911d'),
    import('./staff-surface.js?v=20260911d'),
  ]);
  ...
  // Static HTML keeps this action disabled while async checkout dependencies load.
  // Enable only after validation, cart, address, and payment listeners all exist.
  calculate.disabled = false;
}
