import { shippingServiceLabel, shippingServiceSummary } from './shipping-service-label.js?v=20260912a';
import { catalogImageDimensions } from './main/catalog-data.js?v=20260912a';
import {
  createShippingRequestCoordinator,
  fetchShippingJson,
  shippingRequestSnapshot,
} from './shipping-request.js?v=20260912a';
...
async function boot() {
  const [cartModule, autocompleteModule, authModule, staffModule] = await Promise.all([
    import('./cart.js'),
    import('./address-autocomplete.js?v=20260912a'),
    import('./auth.js?v=20260912a'),
    import('./staff-surface.js?v=20260912a'),
  ]);
