import { shippingServiceLabel, shippingServiceSummary } from './shipping-service-label.js?v=20260820b';
import { catalogImageDimensions } from './main/catalog-data.js?v=20260820b';
import {
  createShippingRequestCoordinator,
  fetchShippingJson,
  shippingRequestSnapshot,
} from './shipping-request.js?v=20260820b';
...
async function boot() {
  const [cartModule, autocompleteModule, authModule, staffModule] = await Promise.all([
    import('./cart.js'),
    import('./address-autocomplete.js?v=20260820b'),
    import('./auth.js?v=20260711w'),
    import('./staff-surface.js?v=20260820b'),
  ]);
