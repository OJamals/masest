...
values
  ...
  ('pricing_tier', 'standard', 'Standard', 'published', 'en', '{"badge":"Silver · Most chosen","name":"Standard","audience":"Mid-size, schools, commercial","price":"$900-1,800","price_unit":"/ mo","annual":"$10.8K-21.6K / yr","features":["Everything in Bronze, plus CR, Neutral, Descaler","Monthly visit and analysis","Automated Advantage controller","Annual ASHRAE 188 update"],"replaces":"Configured against the current incumbent program","cta":"Quote Silver","href":"contact?type=quote&product=Full%20Cooling%20Tower%20Program","featured":true,"sort_order":2,"active":true}'::jsonb, '{}'::jsonb),
  ('pricing_tier', 'premium', 'Premium', 'published', 'en', '{"badge":"Gold","name":"Premium","audience":"Districts, hospitals, universities","price":"$2,200-4,500","price_unit":"/ mo","annual":"$26.4K-54K / yr","features":["Everything in Silver, plus glycol management, MultiWash, AlumiBrite","Bi-weekly service","ASHRAE 188 water-management-plan scope review","Water-management assessment and injection-system scope"],"replaces":"Configured against the current incumbent program","cta":"Quote Gold","href":"contact?type=quote&product=Full%20Cooling%20Tower%20Program","featured":false,"sort_order":3,"active":true}'::jsonb, '{}'::jsonb),
  ('pricing_tier', 'full-lifecycle', 'Full Lifecycle', 'published', 'en', '{"badge":"Platinum","name":"Full Lifecycle","audience":"Districts, hospitals, aerospace","price":"$5,000-15,000+","price_unit":"/ mo","annual":"$60K-180K+ / yr","features":["Everything in Gold, plus DDC design and commissioning","Weekly monitoring; response terms quoted by site","WMP engineering review; testing cadence quoted by site","EHSS and public-sector procurement file review"],"replaces":"Configured against the current incumbent program","cta":"Quote Platinum","href":"contact?type=quote&product=Full%20Cooling%20Tower%20Program","featured":false,"sort_order":4,"active":true}'::jsonb, '{}'::jsonb)
